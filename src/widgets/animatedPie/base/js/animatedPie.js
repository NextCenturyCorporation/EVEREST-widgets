...
var animatedPie_base = {};

animatedPie_base.execute = function() {
	init();
};

animatedPie_base.update = function() {
};
...
var frequency = 15000;
var updateInterval = window.setInterval(update, frequency);
...
function update() {
  ...
  if(filteredPieData.length > 0 && oldPieData.length > 0){
    ...
    lines = this.label_group.selectAll("line").data(filteredPieData);
