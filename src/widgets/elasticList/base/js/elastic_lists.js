    ...
    col_vals.forEach(function(e,i){ 
      if(facets[i]["type"] == "T") {
        bin_vals[i] = e;         
      	...
      	console.log("col_vals " + col_vals[i]);

      	var increment = parseFloat(facets[i]["step"]);
      	console.log("increment = " + increment);

      	var loVal = parseFloat(col_vals[i].shift());
      	var hiVal = parseFloat(col_vals[i].pop());
      	
      	console.log("loVal = " + loVal);
      	console.log("hiVal = " + hiVal);

      	var loRange = Math.round((loVal - increment) / increment) * increment;
      	var hiRange = Math.ceil((hiVal + increment) / increment) * increment;
      	
      	console.log("loRange = " + loRange);
      	console.log("hiRange = " + hiRange);
      	
        bin_vals[i] = pv.range(loRange, hiRange, increment);

        console.log("bins = " + bin_vals[i]);
        
      }
    });   

    // Build histogram bins                        
    // Note: All the function junk in there is to memorize/cache based
