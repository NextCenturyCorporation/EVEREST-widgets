...
describe('Test src/widgets/rawFeed/js/table.js base functions', function(){
	...
	describe('Tests the functionality of sorter', function(){
		...
		it('for switching to descending sort with simple element', function(){
			...
			expect(datas[0].ent1).toEqual("the ongoing reports of fraud");
			expect(datas[1].ent1).toEqual("the defendant");
			expect(datas[2].ent1).toEqual("his co-conspirators");
			expect(datas[3].ent1).toEqual("# co-conspirators");
		});
